...
<head>
    ...
    <style>
        * {
        ...
        .btn-catalog i:first-child {
            animation: heartBeat 1.5s ease-in-out infinite;
        }
        
        .btn-catalog i:last-child {
            transition: transform 0.3s ease;
        }
        
        .btn-catalog:hover i:last-child {
...
<div class="login-container">
    ...
    <div class="left-side">
        ...
        <div class="brand-section">
            <h1 class="main-title">
                Kelola bisnis & stok<br>
                <span class="highlight">Siap berkembang lebih besar</span>
            </h1>
            
            <p class="description">
                Sistem POS modern untuk mengelola penjualan, stok, dan membuka peluang pertumbuhan bisnis dalam satu platform.
            </p>
            
            <ul class="features">
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Multi-cabang dalam satu sistem</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Laporan real-time & analitik</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Stok rapih & siap memenuhi permintaan besar</span>
                </li>
            </ul>
            ...
            <div class="articles-section">
                ...
                <div class="articles-list">
                    ...
                    <a href="{{ route('artikel.index') }}" class="article-item">
                        <div class="article-icon">
                            <i class="bi bi-file-text"></i>
                        </div>
                        <div class="article-content">
                            <h4>{{ Str::limit($artikel->judul, 40) }}</h4>
                            <p>{{ Str::limit(strip_tags($artikel->konten), 60) }}</p>
                        </div>
                    </a>
                    @endforeach
                </div>
            ...
            <div class="info-section">
                ...
                <div class="info-card">
                    ...
                    <div class="info-text">
                        ...
                        <p>Dashboard lengkap untuk keputusan bisnis</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <form action="{{ route('login.post') }}" method="POST">
                ...
                <div class="form-options">
                    ...
                    <a href="{{ route('password.request') }}" class="forgot-link" style="font-size:.8rem">lupa password?</a>
                </div>
